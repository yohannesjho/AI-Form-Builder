...
export async function POST(req) {
  try {
    ...
    only give me the json object has the form name and  fields Include field labels, types (e.g., text, email, checkbox), 
    and placeholder values.and always remember if the user provides you the field names just use only those fields 
    if they dont specify you the field name generate your own fields based on the description `;
